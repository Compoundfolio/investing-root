  ...
  useEffect(() => {
    ...
    fetch(process.env.NEXT_PUBLIC_API_BASE_URL + "/auth/google", {
      ...
      if (response.ok) {
        ...
        throw new Error("Backend responded with bad response code: " + response)
      }
    }).then(body => {
      onSuccess(body)
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full gap-4">
      ...
      <div className="text-center">
        <h1 className="text-white text-shadow-white">Connecting to your google account</h1>
        {/* TODO: Rename */}
        <small className="text-gray-400">It may take between <b>5s</b> to <b>30s</b> ...</small>
      </div>
    </div>
  )
}
