import { NonTradeTransaction, normalizeArrayOfObjectsBy, oldDatesFirst, parseNumberToFixed2 } from "@core";
...
const getCommissions = (allNonTradeTransactions: NonTradeTransaction[]): NormalizedValueChartDataSet => {
