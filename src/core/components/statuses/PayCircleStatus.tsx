...
const PayCircleStatus = ({ payDate, payStatusColor }: IPayCircleStatus) => {
  const statusColor = useMemo(
    () => payStatusColor ?? getPayStatusColor(payDate),
    [payStatusColor, payDate]
  )

  return (
    <svg
      className={styles.circularStatus}
      width="10"
      height="10"
      viewBox="0 0 10 10"
      fill="none"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.364583" stopColor={statusColor.color} />
