    ...
    <svg className={className} width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="add-circle" clipPath="url(#clip0_411_12226)">
        <g id="Vector" filter="url(#filter0_d_411_12226)">
          <path
            d="M27.9993 4.66675C15.1193 4.66675 4.66602 15.1201 4.66602 28.0001C4.66602 40.8801 15.1193 51.3334 27.9993 51.3334C40.8793 51.3334 51.3327 40.8801 51.3327 28.0001C51.3327 15.1201 40.8793 4.66675 27.9993 4.66675ZM39.666 30.3334H30.3327V39.6667H25.666V30.3334H16.3327V25.6667H25.666V16.3334H30.3327V25.6667H39.666V30.3334Z"
            {...colorStyle}
          />
        </g>
      </g>
